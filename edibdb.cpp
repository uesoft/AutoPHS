...
bool EDIBDB::DrawInfoIsNull(_variant_t Obj)
{
	return true;
}
...
void EDIBDB::AnalysisFieldsMAT(CString B, _variant_t fld())
{
}
...
void EDIBDB::MDB2Txt(_variant_t MyData)
{
}
...
void EDIBDB::AnalysisFields(CString B, _variant_t fld())
{
}
