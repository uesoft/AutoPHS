...
public:
    ...
    static void SaveDwgAndExitACAD(_variant_t prompt, _variant_t DwgName);
    static void CloseAcadWin(_variant_t /*Optional*/ ExitMode);
    ...
    static void ModifyAttBG(float /*ByVal*/ ELvalue, _variant_t /*Optional*/ BGtype, _variant_t /*Optional*/ strTagStringOfBG);
    ...
    static void DrawTagByPickEntity(_variant_t /*Optional*/ pnt);
...
//    static void VBSetXdata(/*Object*/VOID ent, _variant_t /*ByVal*/ vbApp, _variant_t ParamArray xData());
//    static bool VBGetXdata(/*Object*/VOID ent, CString /*ByVal*/ vbApp, int xdataType(), _variant_t xData());
//    static bool VBGetEXdata(/*Object*/VOID ent, CString /*ByVal*/ vbApp, _variant_t /*Optional*/ IxdataType, _variant_t /*Optional*/ VxData);
