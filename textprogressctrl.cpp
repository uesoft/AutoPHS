...
public:
    ...
    CMemDC(CDC* pDC) : CDC()
    {
        ...
        if (m_bMemDC)    // Create a Memory DC
        {
            ...
            SetWindowOrg(m_rect.left, m_rect.top);//设置设备上下文的窗口初始位置
        }
...
LRESULT CTextProgressCtrl::OnGetText(WPARAM wParam/*cchTextMax*/,LPARAM lParam/* LPTSTR szText*/)
{
...
void CTextProgressCtrl::OnPaint() 
{
	...
	PaintDC.GetCurrentFont()->GetLogFont(&lf);
...
void CTextProgressCtrl::SetTextFont(LPCTSTR lpszFontName, int nHeight, BOOL bBold)
{
	LOGFONT lf;
	if(m_TextFont.GetSafeHandle())
	{
