...
//		}
//
//		//悬臂iSACantilever Cphs.cpp(3475,3482)
...
//		}
//
//		//板肋螺栓简支吊iG52_55 Cphs.cpp(3499,3533)
...
//		}
//
//		//9,混凝土梁/板/支墩/etc iGCement Cphs.cpp(4405~4409)
...
//		}
//
//		//三角支架G48 iSALbraceFixG48 Cphs.cpp(3537,4390)
...
//		}
//
//		//用户自定义根部 iG100 Cphs.cpp(4393,4402)
//		CString BuildSeleSQLSA::GetiG100SQL(CString &Ptype)
//		{
//			CString strSQL=_T("");
//			//用户自定义根部按用户输入的规格号选择
//			//m_SAPara->giSAG100No=_ttoi(FrmTxsr.m_pViewTxsr->m_PagOption->m_csSAG100No);//原代码cg?
...
//			try
//			{
//				//公式中变量的单位:m_Para->mvBWidth,cm;PAfixH,mm->cm; m_SAPara->gdw,mm->cm; 所有力矩,kgf.m->kgf.cm; 所有力,kgf->kgf.
